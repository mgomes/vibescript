...
var memberContracts = []memberContract{
	...
	scalarConversionContract("money", "inspect", checkTypeString),
	scalarConversionContract("time", "inspect", checkTypeString),
	scalarConversionContract("array", "to_s", checkTypeString),
	scalarConversionContract("array", "string", checkTypeString),
	scalarConversionContract("range", "to_s", checkTypeString),
	scalarConversionContract("range", "string", checkTypeString),
	scalarConversionContract("range", "inspect", checkTypeString),
	scalarConversionContract("duration", "to_s", checkTypeString),
	scalarConversionContract("duration", "string", checkTypeString),
	scalarConversionContract("duration", "inspect", checkTypeString),
