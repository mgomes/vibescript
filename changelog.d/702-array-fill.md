- **Added: Ruby-style `Array#fill`.** `fill` replaces all or part of an array
  ...
  range that runs past the end grows the result and pads any gap with `nil`, and
  the value and block forms are mutually exclusive. Like the neighboring array
