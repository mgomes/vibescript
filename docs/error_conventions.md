...
| Domain-specific | fixed strings | Arithmetic and bounds keep their conventional short forms: `division by zero`, `modulo by zero`, `array index out of bounds`, `string index out of bounds`, `money currency mismatch`. |
